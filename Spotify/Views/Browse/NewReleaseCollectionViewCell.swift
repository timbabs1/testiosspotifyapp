...
//  Spotify
//
//  Created by Babz Haastrup on 04/08/2021.
//
...
class NewReleaseCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        numberOfTracksLabel.frame = CGRect(x: albumCoverImageView.right+10, y: albumCoverImageView.bottom-44, width: numberOfTracksLabel.width, height: 44)
    }
